export const all = /*html*/ `
	<div>
		...
		<v-server-table ref="table" :url="api_url+'users'" :columns="prop.columns"  :options="options">
		...
		<view-user-component :prop="prop"></view-user-component>
		<edit-user-component :prop="prop"></edit-user-component>
		<del-user-component :prop="prop"></del-user-component>
	</div>`