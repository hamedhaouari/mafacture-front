export const all = /*html*/ `
	<div>
		...
		<v-server-table ref="table" :url="api_url+'prestataires'" :columns="prop.columns"  :options="options">
		...
		<create-prestataire-component ></create-prestataire-component>
		<view-prestataire-component :prop="prop"></view-prestataire-component>
		<edit-prestataire-component :prop="prop"></edit-prestataire-component>
		<del-prestataire-component :prop="prop"></del-prestataire-component>
	</div>`