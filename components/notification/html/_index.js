export const all = /*html*/ `
	<div>
		...
		<v-server-table ref="table" :url="api_url+'notifications'" :columns="prop.columns"  :options="options">
		...
		<create-notification-component ></create-notification-component>
		<view-notification-component :prop="prop"></view-notification-component>
		<edit-notification-component :prop="prop"></edit-notification-component>
		<del-notification-component :prop="prop"></del-notification-component>
	</div>`